 ...
 *
 * $Revision: 81 $
 * $Id: insertclassmethoddlg.cpp 81 2022-09-26 18:47:50Z pecanh $
 * $HeadURL: https://svn.code.sf.net/p/cb-clangd-client/code/trunk/clangd_client/src/codecompletion/insertclassmethoddlg.cpp $
 */
